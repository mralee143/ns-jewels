...
CREATE TABLE `Product` (
    ...
    `compareAtPricePaisa` INTEGER NULL,
    `imageSrc` VARCHAR(191) NOT NULL,
    `featureBullets` JSON NULL,
...
CREATE TABLE `User` (
    ...
    `shippingFullName` VARCHAR(191) NULL,
    `shippingPhone` VARCHAR(191) NULL,
    `shippingCountry` VARCHAR(191) NULL DEFAULT 'Pakistan',
    `shippingAddressLine1` VARCHAR(191) NULL,
